        ...
        <nav className={styles.main__nav}> 
            ...
            <div className={styles.nav__menu}>
                <ul className={!active ? `${styles.menu__list} ${styles.menu__list_hidden}` : styles.menu__list}>
                    <li className={styles.menu__item}><Link className={styles.menu__link} to={`/main`}>Главное</Link></li>
                    <li className={styles.menu__item}><Link className={styles.menu__link}to={`/main/compilation`}>Мой плейлист</Link></li>
